...
public class HubConnection extends Connection {
     ...
     */
    public HubConnection(String url, String queryString, boolean useDefaultUrl, Logger logger, Gson gson) {
        super(getUrl(url, useDefaultUrl), queryString, logger,gson);
    }
     ...
     *            The connection URL
     */
    public HubConnection(String url,Gson gson) {
        super(getUrl(url, true),gson);
    }
     ...
     *            indicates if the default SignalR URL should be used
     */
    public HubConnection(String url, boolean useDefaultUrl,Gson gson) {
        super(getUrl(url, useDefaultUrl),gson);
    }
