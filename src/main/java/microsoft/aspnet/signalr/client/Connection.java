...
public class Connection implements ConnectionBase {
     ...
     *            The connection URL
     */
    public Connection(String url,Gson gson) {
        this(url, (String) null,gson);
    }
     ...
     */
    public Connection(String url, String queryString,Gson gson) {
        this(url, queryString, new NullLogger(),gson);
    }
     ...
     */
    public Connection(String url, Logger logger,Gson gson) {
        this(url, null, logger,gson);
    }
     ...
     *            The connection logger
     */
    public Connection(String url, String queryString, Logger logger, Gson gson) {
        if (url == null) {
